								...
								<div class="col-md-6 BorderRight">
									...
									<div class="panel-body">
										...
										<form class="flightform" action="<?php if($_REQUEST['lang']=="ar"){?>PDF/flightpdf_ar.php<?php }else{ ?>PDF/flightpdf.php<?php } ?>" method="post">
											...
											<input type="text" placeholder="<?php echo $lang["IssuePlace"];?>" data-toggle="tooltip" required="required" data-placement="right" id="IssuePlace" name="IssuePlace" title="Please provide Issue Place" value="">
											<br /><br />
