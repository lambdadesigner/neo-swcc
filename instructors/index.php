...
<!-- Morris chart -->
		         ...
		         <?php /* <!-- Small boxes (Stat box) -->
		          ...
		          <div class="row">
		            ...
		            <section class="col-lg-6 connectedSortable">
		            	...
		            	<div class="panel box-solid bg-white-gradient">
		            	 ...
		            	 <div class="box box-solid bg-teal-gradient">
							<div class="box-header">
								<i class="fa fa-th"></i>
								<h3 class="box-title">Today Class Room Booking Status</h3>
							...
							<div class="box-body border-radius-none slimScroll">
								<ul class="todo-list">
				                    <li>
				                      <!-- drag handle -->
				                      <span class="handle">
				                      ...
				                      <!-- todo text -->
				                      <span class="text">Class room number <small class="label label-info"> C01</small>&nbsp Booked By <small class="label label-warning">   Ahmed </small></span>
				                      <!-- Emphasis label -->
									...
									<li>
				                      ...
				                      <!--<input type="checkbox" value="" name="" />-->
				                      <!-- todo text -->
				                      <span class="text">Class room number <small class="label label-info"> C02</small>&nbsp Booked By <small class="label label-warning">   Mohammed </small></span>
				                      <!-- Emphasis label -->
				                      <small class="label label-danger"><i class="fa fa-clock-o"></i> Full</small>
				                      <!-- General tools such as edit or delete-->
				                      <!--<div class="tools">
									...
									<li>
				                      ...
				                      <!--<input type="checkbox" value="" name="" />-->
				                      <!-- todo text -->
				                      <span class="text">Class room number <small class="label label-info"> C03</small>&nbsp Booked By <small class="label label-warning">   Omar </small></span>
				                      <!-- Emphasis label -->
				                      <small class="label label-danger"><i class="fa fa-clock-o"></i> Full</small>
				                      <!-- General tools such as edit or delete-->
				                      <div class="tools">
									...
									<li>
				                      ...
				                      <!--<input type="checkbox" value="" name="" />-->
				                      <!-- todo text -->
				                      <span class="text">Class room number <small class="label label-info"> C04</small>&nbsp Booked By <small class="label label-warning">   Abdallah </small></span>
				                      <!-- Emphasis label -->
				                      <small class="label label-danger"><i class="fa fa-clock-o"></i> Full</small>
				                      <!-- General tools such as edit or delete-->
				                      <div class="tools">
									...
									<li>
				                      ...
				                      <!--<input type="checkbox" value="" name="" />-->
				                      <!-- todo text -->
				                      <span class="text">Class room number <small class="label label-info"> C05</small>&nbsp Booked By <small class="label label-warning">   AbdulJabbar </small></span>
				                      <!-- Emphasis label -->
				                      <small class="label label-danger"><i class="fa fa-clock-o"></i> Full</small>
				                      <!-- General tools such as edit or delete-->
				                      <div class="tools">
									...
									<li>
				                      ...
				                      <!--<input type="checkbox" value="" name="" />-->
				                      <!-- todo text -->
				                      <span class="text">Class room number <small class="label label-info"> C06</small>&nbsp Booked By <small class="label label-warning">   Ahmed </small></span>
				                      <!-- Emphasis label -->
				                      <small class="label label-danger"><i class="fa fa-clock-o"></i> Full</small>
				                      <!-- General tools such as edit or delete-->
				                      <div class="tools">
									...
									<li>
				                      ...
				                      <!--<input type="checkbox" value="" name="" />-->
				                      <!-- todo text -->
				                      <span class="text">Class room number <small class="label label-info"> C07</small>&nbsp Booked By <small class="label label-warning">   Yasser </small></span>
				                      <!-- Emphasis label -->
				                      <small class="label label-danger"><i class="fa fa-clock-o"></i> Full</small>
				                      <!-- General tools such as edit or delete-->
				                      <div class="tools">
		              ...
		              <!-- TO DO List -->
		              <div class="box table-stripedbox">
		                <div class="box-header">
							...
							while($row = sqlsrv_fetch_array($result)){ ?>
		                  	<tr>
								<td><?php echo $row['ModuleID']?></td>
		                  		...
		                  		<td><?php echo date_format($row['StartTime'],'H:i:s')?></td>
		                  		<td><?php echo date_format($row['EndTime'],'H:i:s')?></td>
					...
					var data = [],
					  ...
					  <?php  		
					    ...
					    while($attend_row = sqlsrv_fetch_array($attend_result)){?>
					  	...
					  	<?php  	
						$attend_query = "SELECT FromDate,ToDate FROM ITD_Holidays";
						$attend_result = sqlsrv_query( $conn, $attend_query ,array(), array( "Scrollable" => SQLSRV_CURSOR_KEYSET ));	
					  
					    while($attend_row = sqlsrv_fetch_array($attend_result)){
					    	$absent_date = date_format($attend_row['FromDate'], 'Y-m-d');
					    	echo $ab_year = explode('-',$absent_date);
					    	$mondecr = $ab_year['1'] - 1;
					    	?>
		            ...
		            <div class="box box-info">
						...
						<form name="mails" action="sendingmails.php" method="post">
							<div class="box-body">							
								...
								<input type="hidden" class="form-control" name="adminID" id="adminID" value="Admin" /><!-- value="<?php echo $_SESSION['InstructorID'];?>" -->
							</div>
	...
	$('.inputpickertext,.glyphicon-calendar').click(function(){
		// alert('dasd')
...
//include('instructorsAttendance.php');
