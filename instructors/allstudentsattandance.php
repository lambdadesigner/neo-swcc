...
include('../includes/database.php');
	...
	$instAttend = "SELECT * FROM StudentAbsent where StudentID='".$_GET['Inuser']."' AND DateAbsent >= '".$startD."0101' AND DateAbsent <=  '".$EndD."1231'"; 
...
<script type="text/javascript">
	...
	<?php
	  ...
	  if($Imonth[1]=="01"){
	  	$instAttend1 = "SELECT * FROM StudentAbsent where StudentID='".$_GET['Inuser']."' AND DateAbsent >= '".$startD."0101' AND DateAbsent <=  '".$EndD."0131'"; 
	...
	<?php } if($Imonth[1]=="02"){
	 	$instAttend2 = "SELECT * FROM StudentAbsent where OriginalInstructor='".$_GET['Inuser']."' AND DateAbsent >= '".$startD."0201' AND DateAbsent <=  '".$EndD."0229'"; 
	...
	<?php } if($Imonth[1]=="03"){
		$instAttend3 = "SELECT * FROM StudentAbsent where OriginalInstructor='".$_GET['Inuser']."' AND DateAbsent >= '".$startD."0301' AND DateAbsent <=  '".$EndD."0331'"; 
	...
	<?php } else{?> 
	{
	 ...
	 <?php } if($Imonth[1]=="04"){
	 	$instAttend4 = "SELECT * FROM StudentAbsent where OriginalInstructor='".$_GET['Inuser']."' AND DateAbsent >= '".$startD."0401' AND DateAbsent <=  '".$EndD."0430'"; 
	...
	<?php } else{?> 
	{
	 ...
	 <?php } if($Imonth[1]=="05"){
	 	$instAttend5 = "SELECT * FROM StudentAbsent where OriginalInstructor='".$_GET['Inuser']."' AND DateAbsent >= '".$startD."0501' AND DateAbsent <=  '".$EndD."0531'"; 
	 ...
	 <?php } else{?> 
	{
	 ...
	 <?php } if($Imonth[1]=="06"){
	 	$instAttend6 = "SELECT * FROM StudentAbsent where OriginalInstructor='".$_GET['Inuser']."' AND DateAbsent >= '".$startD."0601' AND DateAbsent <=  '".$EndD."0630'"; 
	...
	<?php } else{?> 
	{
	 ...
	 <?php } if($Imonth[1]=="07"){
	 	$instAttend7 = "SELECT * FROM StudentAbsent where OriginalInstructor='".$_GET['Inuser']."' AND DateAbsent >= '".$startD."0701' AND DateAbsent <=  '".$EndD."0731'"; 
	 ...
	 <?php } else{?> 
	{
	 ...
	 <?php } if($Imonth[1]=="08"){
	 	$instAttend8 = "SELECT * FROM StudentAbsent where OriginalInstructor='".$_GET['Inuser']."' AND DateAbsent >= '".$startD."0801' AND DateAbsent <=  '".$EndD."0831'"; 
	 ...
	 <?php } else{?> 
	{
	 ...
	 <?php } if($Imonth[1]=="09"){
	 	$instAttend9 = "SELECT * FROM StudentAbsent where OriginalInstructor='".$_GET['Inuser']."' AND DateAbsent >= '".$startD."0901' AND DateAbsent <=  '".$EndD."0930'"; 
	 ...
	 <?php } else{?> 
	{
	 ...
	 <?php } if($Imonth[1]=="10"){
	 	$instAttend10 = "SELECT * FROM StudentAbsent where OriginalInstructor='".$_GET['Inuser']."' AND DateAbsent >= '".$startD."1001' AND DateAbsent <=  '".$EndD."1031'"; 
	 ...
	 <?php } else{?> 
	{
	 ...
	 <?php } if($Imonth[1]=="11"){
	 	$instAttend11 = "SELECT * FROM StudentAbsent where OriginalInstructor='".$_GET['Inuser']."' AND DateAbsent >= '".$startD."1101' AND DateAbsent <=  '".$EndD."1130'"; 
	 ...
	 <?php } else{?> 
	{
	 ...
	 <?php } if($Imonth[1]=="12"){
	 	$instAttend12 = "SELECT * FROM StudentAbsent where OriginalInstructor='".$_GET['Inuser']."' AND DateAbsent >= '".$startD."1201' AND DateAbsent <=  '".$EndD."1231'"; 
