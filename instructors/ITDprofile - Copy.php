		...
		font-weight: bolder;
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					...
					<?php 
						$sql ="SELECT * FROM ITD_Instructors WHERE InstructorID='$InstructorID'";
									...
									<div class="panel panel-info">
										...
										<div id="no-more-tables panel-body col-md-12">
											<table class="table-bordered table-striped table-condensed cf">
												...
												<tbody>
													<tr>
														<td class="BoldText">Instructor ID :</td>
													...
													<tr>
														<td class="BoldText">Instructor Special Course : </td>
														<td><?php  echo $row['InstructorSpecialCourse'];?></td>
													</tr>
													<tr>
														<td class="BoldText">Instructor Email : </td>
														<td><?php  echo $row['InstructorEmail'];?>  </td>
													</tr>
													<tr>
														<td class="BoldText">Instructor Phone : </td>
														<td><?php  echo $row['InstructorPhone'];?>  </td>
													</tr>
													<tr>
														<td class="BoldText">Instructor Mobile : </td>
														<td><?php  echo $row['InstructorMobile'];?>  </td>
													</tr>
													<tr>
														<td class="BoldText">Instructor Address1 : </td>
														<td><?php  echo $row['InstructorAddress1'];?>  </td>
													</tr>
													<tr>
														<td class="BoldText">Instructor Address2 : </td>
														<td><?php  echo $row['InstructorAddress2'];?>  </td>
													</tr>
