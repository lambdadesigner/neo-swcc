				...
				var data = [],
				  ...
				  <?php  		
				    ...
				    while($attend_row = sqlsrv_fetch_array($attend_result)){
				  	  ...
				  	  data.push({ title: "<?php echo $attend_row['Status'];?>", start: new Date(<?php echo $ab_year['0'];?>,<?php echo $mondecr;?>, <?php echo $ab_year['2'];?>) });
				  	  //data.push({ title: "Testing", start: new Date(2015, 07, 24, 8, 35), end: new Date(2015, 07, 26, 18, 35), allDay:0/*, text: slipsum[ slipsum.length ]*/  });
			                    ...
			                    <div class="box-body">
			                      ...
			                      <div class="direct-chat-messages wrappers">
			                        ...
			                        <div class="direct-chat-msg">
			                          ...
			                          <img class="direct-chat-img img-circle" src="assets/dist/img/user1-128x128.jpg" alt="message user image" /><!-- /.direct-chat-img -->
			                          <div class="direct-chat-text">
			                      ...
			                      <div class="direct-chat-contacts">
			                        <ul class="contacts-list">
			                          <li>
			                            <a href="#">
			                              <img class="contacts-list-img img-circle" src="assets/dist/img/user1-128x128.jpg" />
			                          ...
			                          <li>
			                            <a href="#">
			                              <img class="contacts-list-img img-circle" src="assets/dist/img/user3-128x128.jpg" />
			                              <div class="contacts-list-info">
			                                <span class="contacts-list-name">
			                                  Nadia Jolie
			                          ...
			                          <li>
			                            <a href="#">
			                              <img class="contacts-list-img img-circle" src="assets/dist/img/user5-128x128.jpg" />
			                              <div class="contacts-list-info">
			                                <span class="contacts-list-name">
			                                  Nora S. Vans
			                          ...
			                          <li>
			                            <a href="#">
			                              <img class="contacts-list-img img-circle" src="assets/dist/img/user6-128x128.jpg" />
			                              <div class="contacts-list-info">
			                                <span class="contacts-list-name">
			                                  John K.
			                          ...
			                          <li>
			                            <a href="#">
			                              <img class="contacts-list-img img-circle" src="assets/dist/img/user8-128x128.jpg" />
			                              <div class="contacts-list-info">
			                                <span class="contacts-list-name">
			                                  Kenneth M.
