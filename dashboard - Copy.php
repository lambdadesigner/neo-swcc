			                    ...
			                    <div class="box-body">
			                      ...
			                      <div class="direct-chat-messages wrappers">
			                        ...
			                        <div class="direct-chat-msg">
			                          ...
			                          <img class="direct-chat-img img-circle" src="dist/img/user1-128x128.jpg" alt="message user image" /><!-- /.direct-chat-img -->
			                          <div class="direct-chat-text">
			                      ...
			                      <div class="direct-chat-contacts">
			                        <ul class="contacts-list">
			                          <li>
			                            <a href="#">
			                              <img class="contacts-list-img img-circle" src="dist/img/user1-128x128.jpg" />
			                          ...
			                          <li>
			                            <a href="#">
			                              <img class="contacts-list-img img-circle" src="dist/img/user3-128x128.jpg" />
			                              <div class="contacts-list-info">
			                                <span class="contacts-list-name">
			                                  Nadia Jolie
			                          ...
			                          <li>
			                            <a href="#">
			                              <img class="contacts-list-img img-circle" src="dist/img/user5-128x128.jpg" />
			                              <div class="contacts-list-info">
			                                <span class="contacts-list-name">
			                                  Nora S. Vans
			                          ...
			                          <li>
			                            <a href="#">
			                              <img class="contacts-list-img img-circle" src="dist/img/user6-128x128.jpg" />
			                              <div class="contacts-list-info">
			                                <span class="contacts-list-name">
			                                  John K.
			                          ...
			                          <li>
			                            <a href="#">
			                              <img class="contacts-list-img img-circle" src="dist/img/user8-128x128.jpg" />
			                              <div class="contacts-list-info">
			                                <span class="contacts-list-name">
			                                  Kenneth M.
