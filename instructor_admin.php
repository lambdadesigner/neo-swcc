		              ...
		              <!-- Custom tabs (Charts with tabs)-->
		            	<div class="panel box-solid bg-white-gradient">
		            		<div class="panel-heading">
		            			<h3 class="panel-title">Some Title
						...
						<form name="mails" action="sendingmails.php" method="post">
							<div class="box-body">							
								<div class="form-group">
									...
									<input type="checkbox" id="RegInstuctors" name="RegInstuctors">All Reg. Instructors
									<input type="checkbox" id="ItdInstructor" name="ItdInstructor">All ITD Instuctors									
								</div>
								<div class="form-group">
