		...
		font-weight: bolder;
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					...
					<?php 
						$querys =	"SELECT * FROM SCStudentInfo WHERE EmpID='$EmpID'";
								...
								<div class="col-md-3 col-sm-3">
									<div class="user-wrapper col-md-8 col-md-offset-2">
										...
										<div class="description user-description text-center">
										   <h4><?php  echo $row['StudentName_en'];?> </h4>
										</div>
									 </div>
								</div>
								<div class="col-md-9">
									<div class="panel panel-info">
										<div class="panel-heading">
											<h3 class="panel-title"><span class="fa fa-user-secret"></span> <span class="fa fa-angle-right"></span> <?php  echo $row['StudentName_en'];?>  Profile</h3>
										</div>
										<div id="no-more-tables panel-body col-md-12">
											<table class="table-bordered table-striped table-condensed cf">
												...
												<tbody>
													<tr>
														<td class="BoldText"><?php echo $lang["Employee ID"];?></td>
														<td><?php  echo $row['EmpID'];?></td>
													</tr>
													<tr>
														<td class="BoldText">Student Name <div class="pull-right"><a href="#Eng">Eng</a> / <a href="#Ara">Ara</a></div></td>
														<td><?php  echo $row['StudentName_en'];?> / <?php  echo $row['StudentName_ar'];?></td>
													</tr>
													<tr>
														<td class="BoldText">Plant <div class="pull-right"><a href="#Eng">Eng</a> / <a href="#Ara">Ara</a></div></td>
														<td><?php  echo $row['Plant_en'];?>/ <?php  echo $row['Plant_ar'];?></td>
													</tr>
													<tr>
														<td class="BoldText">Job <div class="pull-right"><a href="#Eng">Eng</a> / <a href="#Ara">Ara</a></div></td>
														<td><?php  echo $row['JobTitle_en'];?>  <?php  echo $row['JobTitle_ar'];?></td>
													</tr>
