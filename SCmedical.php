						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-6 BorderRight">
									...
									<?php 
										$med_sql = "select * from SCStudentInfo where EmpID = '$EmpID'";
										
										$med_result = sqlsrv_query( $conn, $med_sql ,array(), array( "Scrollable" => SQLSRV_CURSOR_KEYSET ));
										$med_row = sqlsrv_fetch_array($med_result)?>
									<div class="panel-body">
										<h4 class="BorderBottom">Medical Leave form</h4>
										<form class="flightform" name="medicalForm" action="medicalpdf.php" method="post">
											<input type="text" placeholder="National ID, eg: 1091983948" id="NationalId" name="NationalId" class="input" autofocus  data-toggle="tooltip" data-placement="right" title="National ID, eg: 1091983948" value="" required>
											<input type="text" placeholder="Student ID" id="StudentId" name="StudentId" class="input" data-toggle="tooltip" data-placement="right" title="Provide EmpID" value="<?php echo $med_row['EmpID']?>" required>
											...
											<input type="text" maxlength="20" placeholder="Job Title" name="MJobTitle" id="MJobTitle" data-toggle="tooltip" data-placement="right" title="Provide Job Title" required value="<?php echo $med_row['JobTitle_en']?>">											
														...
														<content class="">
															...
															<table class="col-md-12 text-right tables">
																...
																<tr>
																	...
																	<td>
																		نأمل الكشف الطبي على المذكور ، وإفادتنا بالنتيجة.
																		<br>
