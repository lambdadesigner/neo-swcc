...
$sql= "select * from SCSchedule order by Date desc ";
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					...
					<ol class="breadcrumb">
						...
						<li><a href="#"><i class="fa fa-user text-red"></i> <?php echo $lang["schedules"];?></a></li>
					</ol>
				</section>
						...
						<div class="panel-body">
							<div class="row">
								<div class="panel filterable">
									...
									<table class="table table-striped" id="SCschedules" >
										<thead>
											<tr class="filters">
												...
												<th><?php echo $lang["Instructors"].$lang["ID"];?></th>
